    ...
    return (
        <div className="space-y-4 relative">
            ...
            <div className="grid lg:grid-cols-2 gap-px bg-[#333] border border-[#333] selection:bg-[#F5D90A] selection:text-black">
                ...
                <div className="bg-black flex flex-col justify-start p-6 md:p-12 relative overflow-hidden h-full">
                    ...
                    <div className="space-y-4 relative z-10">
                        ...
                        <div className="max-w-md pt-2 space-y-2">
                            {nftContract && (
                                <p className="text-xs text-[#F5D90A] font-mono break-all font-bold">
                                    Contract: {nftContract}
                                </p>
                            )}
                            <p className="text-sm text-[#888] leading-relaxed font-mono break-all">
                                A demonstrative cryptographic artifact showcasing zero-gas, high-frequency bidding capabilities via Yellow Network State Channels and Base Mainnet settlement.
                            </p>
                        </div>
                    </div>
